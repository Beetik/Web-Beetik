...
export class Starfield {
  private readonly page = document.querySelector<HTMLElement>(".page");
  ...
  private createConstellations(width: number, height: number): Constellation[] {
  ...
  private drawGlow(x: number, y: number, radius: number, opacity: number, color: string): void {
