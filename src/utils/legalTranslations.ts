...
export const legalTranslations: Translations = {
  "es": {
    ...
    "terms_privacy_0": "La Política de Privacidad explica el acceso, uso, conservación y eliminación de información y los compromisos relativos a las APIs de Google. Para dudas sobre estos términos, soporte o solicitudes relacionadas con tus datos, escribe a contactobeetik@gmail.com.",
  ...
  "en": {
    ...
    "privacy_rights_1": "To request information about your data, access, correction, deletion, or to object to processing, write to contactobeetik@gmail.com with the application, associated email address, and your request. We may ask for the minimum information needed to verify your identity and prevent unauthorized requests. Do not send passwords or tokens. We will inform you about follow-up and any applicable legal limitation.",
    ...
    "terms_account_0": "You are responsible for protecting access to your account, reviewing granted permissions, and checking the configuration of automations you enable. Report any unauthorized use you detect to contactobeetik@gmail.com and revoke compromised connections from your Google Account. Never share passwords or tokens by email.",
    ...
    "terms_privacy_0": "The Privacy Policy explains information access, use, retention, and deletion, and commitments relating to Google APIs. For questions about these terms, support, or requests concerning your data, write to contactobeetik@gmail.com.",
